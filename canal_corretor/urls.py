...
url(r'^portal/$', views.portal, name="portal"), # portal do site é a página de boas vindas
#cadatros
...
url(r'^categorias/(?P<pk>[0-9]+)/$', views.categoria, name="categoria"), # lista as categorias do empreendimentos 
